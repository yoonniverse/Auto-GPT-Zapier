...
from .zapier import ZapierNLAWrapper
...
class ZapierPlugin(AutoGPTPluginTemplate):

    def __init__(self):
        super().__init__()
        self._name = "Auto-GPT-Plugin-Zapier"
        self._version = "0.1.0"
        self._description = "This is Zapier plugin for Auto-GPT."
